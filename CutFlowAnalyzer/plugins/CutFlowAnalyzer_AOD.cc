...
{
public:
  explicit CutFlowAnalyzer_AOD(const edm::ParameterSet&);
  ~CutFlowAnalyzer_AOD();
...
//
CutFlowAnalyzer_AOD::CutFlowAnalyzer_AOD(const edm::ParameterSet& iConfig)
...
CutFlowAnalyzer_AOD::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
  ...
  if( histo_name ){
	...
	// std::cout << "\tTrigger path: " << trigName << std::endl;
...
void CutFlowAnalyzer_AOD::FillTrigInfo( TH1F * h1, const edm::TriggerNames& triggerNames, std::map<int,std::string> nameAndNumb )
{
...
void 
CutFlowAnalyzer_AOD::beginRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a run  ------------
void 
CutFlowAnalyzer_AOD::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
CutFlowAnalyzer_AOD::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
CutFlowAnalyzer_AOD::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
CutFlowAnalyzer_AOD::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(CutFlowAnalyzer_AOD);
